...
const Experience = () => {
    return (
        <div className='grid grid-cols-2 pl-10 gap-12 py-12 '>
            <div>
                <ul className='flex flex-col justify-between h-[523px]'>
            ...
            <div>
                <img className='object-cover w-[664px] h-[523px]' src="https://www.riddhidisplay.com/wp-content/uploads/2021/04/experience-35.jpg" alt="expimg" />
            </div>
        </div>
    )
}
