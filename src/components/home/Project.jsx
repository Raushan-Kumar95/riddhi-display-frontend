    ...
    return (
        <div className='flex flex-col gap-4 sm:px-16 px-4 py-8'>
            ...
            <div className="grid grid-rows-3 sm:gap-12 gap-12">
                ...
                <div className='flex sm:flex-row flex-col sm:gap-28 gap-12'>
                    ...
                    <div className='flex flex-col h-[371px] sm:justify-between gap-10'>
                        ...
                        <ul className=''>
                            <li className="before:content-['>'] before:pr-2">Our team worked hard over the layout designing & MEP in order to ensure <span className='sm:pl-4'> practical implementation of equipments in the space provided</span></li>
                ...
                <div className='flex sm:flex-row flex-col-reverse gap-12'>
                    <div className='flex  flex-col h-[371px] py-2 pr-12 sm:justify-between gap-8'>

                        <h1 className='text-3xl font-bold'> Bikanerwala </h1>
                        <ul className=''>
