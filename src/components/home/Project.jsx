...
const Project = () => {
    return (
        <div className='flex flex-col gap-4 md:px-16 px-4 py-8'>
            <h1 className='text-center font-bold text-4xl py-2'> Our Latest Projects </h1>
            <div className="grid grid-rows-3 md:gap-12 gap-12">
                {/* row 1 */}
                <div className='flex md:flex-row flex-col-reverse gap-12'>
                    <div className='flex  flex-col h-[371px] py-2 pr-12 gap-8 md:justify-between'>
                        ...
                        <ul className=''>
                            ...
                            <li className="before:content-['>'] before:pr-2">We provided end to end kitchen planning and layout designing before <span className='md:pl-4'> execution of the project </span></li>
                    ...
                    <div className="md:w-[665px] md:px-12 md:py-12 md:h-[371px]">
                ...
                <div className='flex md:flex-row flex-col md:gap-32 gap-12 sm:gap-0'>
                    <div className=" md:py-12 md:h-[371px]">
                        <img className=' rounded-xl ' src="https://www.riddhidisplay.com/wp-content/uploads/2021/06/Untitled-2.png" alt="" srcset="" />
                    </div>
                    <div className='flex flex-col h-[371px] md:justify-between gap-10'>
                ...
                <div className='flex md:flex-row flex-col-reverse gap-12 justify-between'>
                    <div className='flex  flex-col h-[371px] py-2 pr-12 gap-8 md:justify-between'>
                        <h1 className='text-3xl font-bold'> Deloitte Hyderabad </h1>
                        <ul className=''>
                    ...
                    <div className="md:w-[665px] md:px-24 md:py-12 md:h-[371px]">
