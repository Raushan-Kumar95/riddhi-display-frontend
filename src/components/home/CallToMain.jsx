...
const CallToMain = () => {
    return (
        <section className='CallToMain-Section flex gap-4 md:px-16 px-4 py-8 bg-red-700 w-full justify-center uppercase text-white'>
            <div className='flex gap-8 md:flex-row flex-col justify-center items-center'>
                <div class="flex gap-4 items-center border px-4 py-4 pr-20">
                    ...
                    <div class="text">
                        ...
                        <a className='font-bold' href="tel:+91 9825072799">+91 7717788162</a>
                    </div>
                </div>
                <div class="flex gap-4 items-center border px-4 py-4 pr-16">
                    ...
                    <div class="text">
                        ...
                        <a  className='font-bold' href="mailto:info@riddhidisplay.com">roshntn@gmail.com</a></div>
                </div>
            </div>
