                ...
                >
                    <SwiperSlide>
                        <div className='h-screen w-screen bg-[url("src/assets/images/banner_slider/IMG_0068-F-scaled-1.jpg")] bg-cover'>
                            ...
                            <div className='relative z-10 flex flex-col justify-center items-center py-44 text-white md:pl-0 sm:pl-10'>
                                ...
                                <p className='text-center md:text-2xl text-2xl p-7 md:w-[1150px] w-[450px]'>We always try to deliver best so that you can maximize your output on each investment. It will surely add some.</p>
                    ...
                    <SwiperSlide>
                        ...
                        <div className='w-screen h-screen absolute bg-black  opacity-50'></div>
                            <div className='relative z-10 flex flex-col justify-center items-center py-44 text-white md:pl-0 sm:pl-10'>
                                ...
                                <p className='text-center md:text-2xl text-2xl p-7 md:w-[1150px] w-[450px]'>We will be dedicated and determined to deliver, whatever we promise in-time. We will not over commit and under deliver.</p>
                                <button className='bg-red-600 md:py-3 py-1 md:px-16 px-8 md:rounded-xl rounded-lg font-bold text-xl'>OUR SERVICES</button>
                            </div>
                        </div>
                    </SwiperSlide>
