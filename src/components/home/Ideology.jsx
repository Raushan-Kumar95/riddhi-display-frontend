        ...
        <div className='py-10 my-5 w-full bg-[url("src/assets/Imageslist-1/ideology-left.png")]'>
                ...
                <div className='grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8 mx-16'>
                    <div className='text-center py-4 px-7 box rounded-md bg-white'>
                        ...
                        <h3 className='text-2xl font-bold pb-4 text-gray-800'>Relationship for Life</h3>
                    ...
                    <div className='text-center py-4 px-7 box rounded-md bg-white'>
                        ...
                        <h3 className='text-2xl font-bold pb-4 text-gray-800'>Commitment</h3>
                    ...
                    <div className='text-center py-4 px-7 box rounded-md bg-white'>
                        ...
                        <h3 className='text-2xl font-bold pb-4 text-gray-800'>Innovative Solution</h3>
                    ...
                    <div className='text-center py-4 px-7 box rounded-md bg-white'>
                        ...
                        <h3 className='text-2xl font-bold pb-4 text-gray-800'>Team Work</h3>
