    ...
    return (
        <div>
            <div className='bg-gray-100 py-5 my-5'>
                <div className='grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-2 md:mx-16 mx-2 my-2'>
                    <div className='h-screen w w-full md:px-28 px-2'>
                        <Swiper
                            slidesPerView={"auto"}
                            spaceBetween={30}
                            autoplay={{ delay: 3000 }}
                        ...
                        >
                            <SwiperSlide>
                                <img className='h-screen w-full py-20' src={ceCertificate} alt="ceCertificate" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <img className='h-screen w-full py-20' src={isoCertificate} alt="isoCertificate" />
                            </SwiperSlide>
                        </Swiper>
                    </div>
