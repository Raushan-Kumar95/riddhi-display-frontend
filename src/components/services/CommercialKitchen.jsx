    ...
    <div>
        <div className='flex md:flex-row flex-col-reverse gap-5 md:my-16 md:mx-16 my-8 mx-8'>
            <div className='flex flex-col gap-6 md:text-lg text-base'>
                <h1 className='md:text-5xl text-3xl font-extrabold' > <span className='text-red-500'>Commercial Kitchen</span> <span className='text-gray-800'>Layout Design</span>  </h1>
